...
$wdan_plugin_info = array(
	...
	'load_factory_modules' => array(
		...
		array( 'libs/factory/templates', 'factory_templates_134', 'all' ),
		array( 'libs/factory/freemius', 'factory_freemius_170', 'all' ),
		array( 'libs/factory/adverts', 'factory_adverts_159', 'admin' ),
		//array('libs/factory/logger', 'factory_logger_149', 'all')
	)
);

$wdan_compatibility = new Wbcr_Factory480_Requirements( __FILE__, array_merge( $wdan_plugin_info, array(
